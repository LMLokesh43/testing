...
const buttonStyle = (theme: Theme) => createStyles({
  ...
  primary: {
    ...
    boxShadow: `0 2px 2px 0 ${hexToRGBAlpha(
      ...
      theme.palette.primary.main,
      0.2
      )}, 0 1px 5px 0 ${hexToRGBAlpha(theme.palette.primary.main, 0.12)}`,
    "&:hover,&:focus": {
      backgroundColor: theme.palette.primary.main,
  ...
  info: {
    ...
    boxShadow: `0 2px 2px 0 ${hexToRGBAlpha(
      ...
      theme.palette.info.main,
      0.2
      )}, 0 1px 5px 0 ${hexToRGBAlpha(theme.palette.info.main, 0.12)}`,
    "&:hover,&:focus": {
      backgroundColor: theme.palette.info.main,
      boxShadow: `0 14px 26px -12px ${hexToRGBAlpha(
        theme.palette.info.main,
  ...
  success: {
    ...
    boxShadow: `0 2px 2px 0 ${hexToRGBAlpha(
      ...
      theme.palette.success.main,
      0.2
      )}, 0 1px 5px 0 ${hexToRGBAlpha(theme.palette.success.main, 0.12)}`,
    "&:hover,&:focus": {
      backgroundColor: theme.palette.success.main,
      boxShadow: `0 14px 26px -12px ${hexToRGBAlpha(
        theme.palette.success.main,
  ...
  warning: {
    ...
    boxShadow: `0 2px 2px 0 ${hexToRGBAlpha(
      ...
      theme.palette.warning.main,
      0.2
      )}, 0 1px 5px 0 ${hexToRGBAlpha(theme.palette.warning.main, 0.12)}`,
    "&:hover,&:focus": {
      backgroundColor: theme.palette.warning.main,
      boxShadow: `0 14px 26px -12px ${hexToRGBAlpha(
        theme.palette.warning.main,
  ...
  danger: {
    ...
    boxShadow: `0 2px 2px 0 ${hexToRGBAlpha(
      ...
      theme.palette.error.main,
      0.2
      )}, 0 1px 5px 0 ${hexToRGBAlpha(theme.palette.error.main, 0.12)}`,
    "&:hover,&:focus": {
      backgroundColor: theme.palette.error.main,
      boxShadow: `0 14px 26px -12px ${hexToRGBAlpha(
        theme.palette.error.main,
  ...
  secondary: {
    ...
    boxShadow: `0 2px 2px 0 ${hexToRGBAlpha(
      ...
      theme.palette.secondary.main,
      0.2
      )}, 0 1px 5px 0 ${hexToRGBAlpha(theme.palette.secondary.main, 0.12)}`,
    "&:hover,&:focus": {
      backgroundColor: theme.palette.secondary.main,
      boxShadow: `0 14px 26px -12px ${hexToRGBAlpha(
        theme.palette.secondary.main,
